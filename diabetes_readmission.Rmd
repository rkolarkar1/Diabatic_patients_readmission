---
title: "Readmission of diabatic patient"
...
Loading the data
```{r}
raw.data <- read.csv("C:/Users/Dell/Desktop/Data Analysis/Predicting-Hospital-Readmission-for-Diabetes-patients-master/diabetes_allcols.csv",sep = ",", header = T, na.strings = "?")
head(raw.data)
summary(raw.data)
```
